          ...
          <AnimatePresence mode="wait">
            {programs.map((program, i) => (
              <motion.div
                ...
                custom={i}
                layout
                className="bg-white/90 backdrop-blur-sm p-6 rounded-2xl shadow-xl border border-gray-100 hover:shadow-2xl transition hover:-translate-y-1 hover:border-[#ff6b3d]/40 hover:bg-[#fff6f2]"
              >
                <motion.img
                  src={program.image}
                  alt={program.name}
