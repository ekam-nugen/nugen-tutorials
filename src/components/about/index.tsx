  ...
  return (
    <section className="relative bg-white py-28 px-6 md:px-16 overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto text-center">
        ...
        >
          <Link href="/ourTeam" className="inline-flex items-center px-6 py-3 bg-gradient-to-r border border-gray-300 from-orange-400 to-purple-400 text-white cursor-pointer hover:shadow-lg font-semibold rounded-full duration-200">
            Meet Our Team
          </Link>
          <Link href="/ourMission" className="bg-white text-[#f37458] px-7 py-3 rounded-full font-semibold border border-[#f37458] backdrop-blur-md shadow-sm hover:bg-[#fff0eb] cursor-pointer transition-all duration-300">
            Our Mission
          </Link>
        </motion.div>
