...
export const mlBootcampCourseFeatures = [
  {
    icon: BadgeCheck,
...
export const mlBootcampUseCases = [
  "Fraud Detection",
...
export const AiBusinessCourseFeatures = [
  {
    icon: BadgeCheck,
    title: "AI Leadership Certification",
    description: "Showcase your ability to lead AI-driven business innovation.",
  },
  {
    icon: Users,
...
export const AiBusinessUseCases = [
...
export const deepLearningCourseFeatures = [
  ...
  },
  {
    ...
    description: "Learn model saving, versioning, and inference on the cloud.",
  },
];
export const deepLearningUseCases = [
...
export const deepLearningCareer = [
  {
    id: 1,
...
export const mlModelCareer = [
  {
    ...
    img: "/frontend.avif",
    benefits: ["🛠️ Docker & K8s", "📡 Monitoring Tools", "⛅ CI/CD Pipelines"],
  },
  {
    id: 2,
...
export const AiStrategyUseCases = [
