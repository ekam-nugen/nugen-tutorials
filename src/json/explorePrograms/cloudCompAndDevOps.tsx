...
export const CloudArchitectCourseFeatures = [
  {
    icon: BadgeCheck,
...
export const CloudArchitectUseCases = [
...
export const CloudArchitectCareer = [
  {
    id: 1,
...
export const AwsSolutionsCourseFeatures = [
  {
    icon: BadgeCheck,
...
export const AwsSolutionsUseCases = [
...
export const AwsSolutionsCareer = [
  {
    id: 1,
  ...
  },
  {
    ...
    img: "/frontend.avif",
    benefits: ["⚙️ Event Triggers", "🛠️ FaaS Architecture", "🔄 Auto Scaling"],
  },
  {
    id: 6,
...
export const DevOpsEngineerCourseFeatures = [
  {
    icon: BadgeCheck,
...
export const DevOpsEngineerUseCases = [
...
export const DevOpsEngineerCareer = [
  {
    id: 1,
  ...
  },
  {
    ...
    img: "/frontend.avif",
    benefits: ["📝 Shell/Python", "📂 Ansible & Terraform", "📡 System Hooks"],
  },
];
export const KubernetesCourseFeatures = [
  {
    icon: BadgeCheck,
  ...
  },
  {
    ...
    description: "Instructors with deep experience in container orchestration.",
  },
  {
    icon: ClipboardCheck,
...
export const KubernetesUseCases = [
...
export const KubernetesCareer = [
  {
    id: 1,
    title: "Kubernetes Developer",
    description: "Develops and deploys containerized apps using K8s.",
    img: "/frontend.avif",
    benefits: ["📦 Helm & YAML", "⚙️ Cluster Management", "📈 App Monitoring"],
  },
  {
    id: 2,
    title: "Cloud Native Developer",
    description: "Builds scalable, portable applications for cloud platforms.",
    img: "/frontend.avif",
...
export const AzureCourseFeatures = [
  {
    icon: BadgeCheck,
  ...
  },
  {
    ...
    description: "Get real-time help and insights from instructors and peers.",
  },
  {
    icon: Building2,
...
export const AzureCareer = [
  ...
  },
  {
    ...
    img: "/frontend.avif",
    benefits: ["🖥️ App Services", "🧩 Azure Functions", "🔐 Managed Identity"],
  },
  {
    id: 6,
